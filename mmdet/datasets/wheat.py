...
class WheatDataset(CustomDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        for i in self.img_ids:
            info = self.coco.loadImgs([i])[0]  # 这里取0看loadImgs的代码
    ...
    def _filter_imgs(self, min_size=32):  # filter image size not bbox size
    ...
    def evaluate(self,
                 ...
                 iou_thrs=np.arange(0.5, 0.76, 0.05)):
...
@DATASETS.register_module()
class Wheat_classes_Dataset(CustomDataset):
