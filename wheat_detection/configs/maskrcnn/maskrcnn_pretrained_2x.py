...
batch_size = 4
n_classes = 1
load_from_pth = '/home/fengyouliang/pth/mask_rcnn_r50_fpn_2x_coco_bbox_mAP-0.392__segm_mAP-0.354_20200505_003907-3e542a40.pth'
...
data = dict(
    ...
    test=dict(
        ...
        img_prefix=data_root + 'train/',
        pipeline=test_pipeline))
evaluation = dict(interval=2, metric=['bbox', 'segm'], interval_iter=-1)
